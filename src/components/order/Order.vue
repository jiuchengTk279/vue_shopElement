            ...
            <el-table :data="ordersList" border stripe>
              ...
              <el-table-column label="操作">
                <template slot-scope="scope">
                  ...
                  <el-button size="mini" type="success" icon="el-icon-location" @click="progressShow"></el-button>
                </template>
              </el-table-column>
            </el-table>
...
export default {
  ...
  methods: {
    ...
    async getOrderList() {
      ...
      // console.log(res)
      // 将响应获得的total赋值给当前的total
      this.total = res.data.total
      // 将响应获的goods赋值给当前的ordersList
